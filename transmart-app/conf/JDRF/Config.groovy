...
environments {
    production {
        grails.assets.url = "http://http://miktmc-ap-ps6a.med.umich.edu/transmart/assets/"
    }
}

quickStartURL = "../../files/JDRF/JDRF_tranSMART_Quick_Start_Guide.pdf"
dataAttestationText = """
        <p>
...
<center>
<br/>
You are about to enter the data sharing center of the JDRF project.<br />
<br />
...
<br/>
Contact <a href="mailto:jdrftmsupport@umich.edu" style="color: #0000EE; text-decoration: underline">support</a> if you have forgotten your username and/or password.
</center>
"""
}
...
com.recomdata.adminEmail = "jdrfTMSupport@umich.edu"

// application title
com.recomdata.appTitle = "JDRF tranSMART"
