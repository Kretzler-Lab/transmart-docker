...
quickStartURL = "../../files/T1D_tranSMART_Quick_Start_Guide.pdf"
scatterPlotURL = "../../files/T1D_scatterplot.pdf"
boxPlotURL = "../../files/T1D_boxplot.pdf"
diffexURL = ""
metabolitesURL = "../../files/Metabolites_in_tranSMART.xlsx"
selectingDataURL = "../../files/T1D_selectingdata.pdf"
dataAttestationText = """
<p>
...
<li>No attempt shall be made to link subject data to a T1D participant.</li>
<li>Any disclosure of data, analysis, or results from tranSMART must be in accordance with appropriate T1D policies and procedures.</li>
<li>Further data analysis on hypotheses generated via tranSMART will be done via existing T1D policies and procedures.</li>
<li>As T1D data are still being collected and cleaned, there will be periodic, announced updates to the data in tranSMART, which may result in changes to analysis results.</li>
</ul>
</p>
"""
...
<br>
<a href="${quickStartURL}" target="_blank">Click here for help using tranSMART.</a>
</center>
"""
}
...
com.recomdata.dataUpload.adminEmail = "T1Dtmsupport@umich.edu"
/* }}} */

/* {{{ Personalization */
// application logo to be used in the login page
com.recomdata.largeLogo = "T1D_logo.png"
com.recomdata.searchtool.smallLogo="T1D_logo.png"
// application logo to be used in the search page
com.recomdata.smallLogo="T1D_logo.png"

// contact email address
com.recomdata.contactUs = "T1Dtmsupport@umich.edu"

// site administrator contact email address
com.recomdata.adminEmail = "T1Dtmsupport@umich.edu"

// application title
com.recomdata.appTitle = "T1D tranSMART"
